...
public class AddController extends HttpServlet {
    ...
    private static final String PRODUCT_PAGE = "SearchController";
            ...
            if (user == null) {
                ...
                if (productID != null && name != null && description != null && 
                    ...
                    try {
                        ...
                        boolean hasAdded = dao.addProduct(productID, name, description, price, size);
                        ...
                        if (hasAdded) {
                            ...
                            request.setAttribute("ERROR", "Failed to add product! Product ID might already exist.");
                        }
